...
public class ShowSubject extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mlist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(ShowSubject.this,ShowTopics.class);
        ...
        final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ShowSubject.this,android.R.layout.simple_list_item_1,myList);
    ...
    public void AddDepartment(View view) {
        ...
        Intent intent = new Intent(ShowSubject.this, AddSubject.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                ...
                startActivity(new Intent(ShowSubject.this,MainActivity.class));
                finish();
                return true;
        }
        return false;
